...
public interface DocumentRepository extends JpaRepository<Document, UUID> {
    ...
    @Query("""
            select new com.fris.boardportal.document.dto.DocumentSummary(
                ...
                d.committeeId, d.rootDocumentId, d.versionNumber, d.createdAt, d.retentionUntil, 0L, false)
            from Document d
    ...
    List<Document> findByRootDocumentIdOrderByVersionNumberDesc(UUID rootDocumentId);
}
